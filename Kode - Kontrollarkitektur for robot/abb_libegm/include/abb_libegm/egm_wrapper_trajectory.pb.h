...
class ExecutionProgress : public ::google::protobuf::Message {
 public:
  ...
  // optional .abb.egm.wrapper.Input inputs = 2;
  ...
  // optional .abb.egm.wrapper.Output outputs = 3;
  ...
  // optional .abb.egm.wrapper.trajectory.TrajectoryGoal active_trajectory = 7;
  inline bool has_active_trajectory() const;
  inline void clear_active_trajectory();
  static const int kActiveTrajectoryFieldNumber = 7;
  ...
  // optional uint32 pending_trajectories = 8;
  inline bool has_pending_trajectories() const;
  inline void clear_pending_trajectories();
  static const int kPendingTrajectoriesFieldNumber = 8;
